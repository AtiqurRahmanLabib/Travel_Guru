        ...
        <div className="w-[1400px] h-[57px] mx-auto mt-5 flex shadow-9xl">
            <nav className="w-[11400px] flex h-[57px] justify-between items-center pb-5">
                ...
                <div className='items-center'>
                    <input className='w-[370px] h-[44px] rounded-[5px] border border-black font-medium font-montserrat text-[16px] text-black p-5' type="text" name="search" id="search" placeholder='Search your Destination...' />
                </div>
                <div className="flex gap-6">
                    <NavLink
                        to="/home"
                        className={({ isActive }) =>
                            `text-[16px] font-medium font-montserrat text-center pt-2.5 
